...
export function VariablesAndWatchSidebar() {
  ...
  return (
    <ErrorBoundary label="VariablesAndWatchSidebar">
      <div className="flex h-full flex-col" data-testid="vars-watch-sidebar">
...
function SectionHeader({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-7 items-center bg-(--color-bg-elevated) px-3 font-display text-[11px] font-semibold tracking-wide text-(--color-fg-tertiary) uppercase">
      {children}
    </div>
  );
}
